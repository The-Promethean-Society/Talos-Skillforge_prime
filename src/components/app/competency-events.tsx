                  ...
                  <Card key={index} className="flex flex-col overflow-hidden transition-transform hover:scale-105 hover:shadow-lg">
                    {questImage && (
                      <div className="relative h-40 w-full">
                        <Image src={questImage.imageUrl} alt={event} fill style={{ objectFit: 'cover' }} data-ai-hint={questImage.imageHint} />
                      </div>
                    )}
                    <CardHeader>
                      <CardTitle className="text-lg font-headline">Quest: {event.split(' ').slice(0, 3).join(' ')}...</CardTitle>
